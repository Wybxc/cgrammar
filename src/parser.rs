...
use crate::{ContextTweaker, ast::*, context::State, span::*, utils::*};
...
pub mod parser_utils {
    ...
    pub type Extra<'a, T> = chumsky::extra::Full<Error<'a>, State<T>, Context>;
...
pub fn primary_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, PrimaryExpression, Extra<'a, T>> + Clone {
    choice((
...
pub fn enumeration_constant<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Identifier, Extra<'a, T>> + Clone {
    identifier()
...
pub fn generic_selection<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, GenericSelection, Extra<'a, T>> + Clone {
    keyword("_Generic")
        .ignore_then(
...
pub fn generic_association_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<GenericAssociation>, Extra<'a, T>> + Clone {
    generic_association()
...
pub fn generic_association<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, GenericAssociation, Extra<'a, T>> + Clone {
    choice((
        keyword("default")
...
#[apply(cached)]
pub fn postfix_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, PostfixExpression, Extra<'a, T>> + Clone {
...
pub fn compound_literal<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, CompoundLiteral, Extra<'a, T>> + Clone {
...
pub fn storage_class_specifiers<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<StorageClassSpecifier>, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn unary_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, UnaryExpression, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn cast_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, CastExpression, Extra<'a, T>> + Clone {
    let cast = type_name()
        .parenthesized()
        .recover_with(recover_parenthesized(TypeName::Error))
...
pub fn binary_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Brand<Expression, BinaryExpression>, Extra<'a, T>> + Clone {
    use chumsky::pratt::*;
...
#[apply(cached)]
pub fn conditional_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Brand<Expression, ConditionalExpression>, Extra<'a, T>> + Clone {
    choice((
        binary_expression()
...
#[apply(cached)]
pub fn assignment_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Brand<Expression, AssignmentExpression>, Extra<'a, T>> + Clone {
...
/// (6.5.17) expression
#[apply(cached)]
pub fn expression<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Expression, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn constant_expression<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, ConstantExpression, Extra<'a, T>> + Clone {
...
/// (6.7) declaration
#[apply(cached)]
pub fn declaration<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Declaration, Extra<'a, T>> + Clone
{
...
pub fn declaration_specifiers<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, (DeclarationSpecifiers, Vec<AttributeSpecifier>), Extra<'a, T>> + Clone {
...
pub fn declaration_specifiers_with_typedef<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, (DeclarationSpecifiers, Vec<AttributeSpecifier>), Extra<'a, T>> + Clone {
    declaration_specifier()
...
#[apply(cached)]
pub fn declaration_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, DeclarationSpecifier, Extra<'a, T>> + Clone {
    choice((
...
pub fn init_declarator_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<InitDeclarator>, Extra<'a, T>> + Clone {
    init_declarator()
        .separated_by(punctuator(Punctuator::Comma))
        .at_least(1)
...
/// (6.7) init declarator
pub fn init_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, InitDeclarator, Extra<'a, T>> + Clone {
    declarator()
...
pub fn typedef_declarator_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<Declarator>, Extra<'a, T>> + Clone {
    typedef_declarator()
        .separated_by(punctuator(Punctuator::Comma))
        .at_least(1)
...
pub fn typedef_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Declarator, Extra<'a, T>> + Clone {
    declarator()
...
#[apply(cached)]
pub fn storage_class_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, StorageClassSpecifier, Extra<'a, T>> + Clone {
    choice((
...
pub fn type_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, TypeSpecifier, Extra<'a, T>> + Clone {
    choice((
...
pub fn struct_or_union_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, StructOrUnionSpecifier, Extra<'a, T>> + Clone {
...
pub fn member_declaration_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<MemberDeclaration>, Extra<'a, T>> + Clone {
    member_declaration()
        .repeated()
...
pub fn member_declaration<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, MemberDeclaration, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn specifier_qualifier_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, SpecifierQualifierList, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn type_specifier_qualifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, TypeSpecifierQualifier, Extra<'a, T>> + Clone {
    choice((
...
pub fn member_declarator_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<MemberDeclarator>, Extra<'a, T>> + Clone {
    member_declarator()
        .separated_by(punctuator(Punctuator::Comma))
        .at_least(1)
...
pub fn member_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, MemberDeclarator, Extra<'a, T>> + Clone {
    choice((
        declarator()
            .or_not()
            .then_ignore(punctuator(Punctuator::Colon))
...
pub fn enum_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, EnumSpecifier, Extra<'a, T>> + Clone {
    keyword("enum")
...
pub fn enumerator_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<Enumerator>, Extra<'a, T>> + Clone {
    enumerator()
...
/// (6.7.2.2) enumerator
pub fn enumerator<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Enumerator, Extra<'a, T>> + Clone {
    identifier()
        .then(attribute_specifier_sequence())
        .then(
...
pub fn atomic_type_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AtomicTypeSpecifier, Extra<'a, T>> + Clone {
    keyword("_Atomic")
        .ignore_then(
            type_name()
                .parenthesized()
...
pub fn typeof_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, TypeofSpecifier, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn type_qualifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, TypeQualifier, Extra<'a, T>> + Clone {
    choice((
...
pub fn function_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, FunctionSpecifier, Extra<'a, T>> + Clone {
    choice((
...
pub fn alignment_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AlignmentSpecifier, Extra<'a, T>> + Clone {
...
/// (6.7.6) declarator
#[apply(cached)]
pub fn declarator<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Declarator, Extra<'a, T>> + Clone {
    let pointer = pointer()
...
#[apply(cached)]
pub fn direct_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, DirectDeclarator, Extra<'a, T>> + Clone {
...
pub fn array_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, ArrayDeclarator, Extra<'a, T>> + Clone {
    choice((
        keyword("static")
...
/// (6.7.6) pointer
#[apply(cached)]
pub fn pointer<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Pointer, Extra<'a, T>> + Clone {
    choice((
...
#[apply(cached)]
pub fn type_qualifier_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<TypeQualifier>, Extra<'a, T>> + Clone {
    type_qualifier()
        .repeated()
        .at_least(1)
...
#[apply(cached)]
pub fn parameter_type_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, ParameterTypeList, Extra<'a, T>> + Clone {
    choice((
...
pub fn parameter_declaration<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, ParameterDeclaration, Extra<'a, T>> + Clone {
...
/// (6.7.7) type name
#[apply(cached)]
pub fn type_name<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, TypeName, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn abstract_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AbstractDeclarator, Extra<'a, T>> + Clone {
    let pointer = pointer()
...
#[apply(cached)]
pub fn direct_abstract_declarator<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, DirectAbstractDeclarator, Extra<'a, T>> + Clone {
...
/// (6.7.8) typedef name
pub fn typedef_name<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Identifier, Extra<'a, T>> + Clone
{
    identifier()
        .try_map_with(|name, extra| {
...
#[apply(cached)]
pub fn braced_initializer<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, BracedInitializer, Extra<'a, T>> + Clone {
...
/// (6.7.10) initializer
#[apply(cached)]
pub fn initializer<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Initializer, Extra<'a, T>> + Clone
{
    choice((
...
pub fn designated_initializer<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, DesignatedInitializer, Extra<'a, T>> + Clone {
    designation()
        .or_not()
        .then(initializer())
...
/// (6.7.10) designation
pub fn designation<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Designation, Extra<'a, T>> + Clone
{
    empty()
        .to(None)
...
/// (6.7.10) designator
pub fn designator<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Designator, Extra<'a, T>> + Clone {
    choice((
        constant_expression()
            .bracketed()
...
pub fn static_assert_declaration<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, StaticAssertDeclaration, Extra<'a, T>> + Clone {
...
/// (6.8) statement
#[apply(cached)]
pub fn statement<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Statement, Extra<'a, T>> + Clone {
    choice((
...
#[apply(cached)]
pub fn unlabeled_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, UnlabeledStatement, Extra<'a, T>> + Clone {
...
/// (6.8.1) label
#[apply(cached)]
pub fn label<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Label, Extra<'a, T>> + Clone {
...
pub fn labelled_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, LabeledStatement, Extra<'a, T>> + Clone {
    label()
...
#[apply(cached)]
pub fn compound_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, CompoundStatement, Extra<'a, T>> + Clone {
    block_item()
        .repeated()
...
/// (6.8.2) block item
pub fn block_item<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, BlockItem, Extra<'a, T>> + Clone {
    choice((
...
pub fn expression_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, ExpressionStatement, Extra<'a, T>> + Clone {
    attribute_specifier_sequence()
        .then(
            expression()
                .map(Box::new)
...
pub fn selection_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, SelectionStatement, Extra<'a, T>> + Clone {
...
pub fn iteration_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, IterationStatement, Extra<'a, T>> + Clone {
...
pub fn jump_statement<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, JumpStatement, Extra<'a, T>> + Clone {
...
#[apply(cached)]
pub fn attribute_specifier_sequence<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<AttributeSpecifier>, Extra<'a, T>> + Clone {
    attribute_specifier()
        .repeated()
        .collect::<Vec<AttributeSpecifier>>()
...
pub fn attribute_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AttributeSpecifier, Extra<'a, T>> + Clone {
    choice((
        old_fashioned_attribute_specifier(),
...
#[apply(cached)]
pub fn old_fashioned_attribute_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AttributeSpecifier, Extra<'a, T>> + Clone {
...
pub fn asm_attribute_specifier<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AttributeSpecifier, Extra<'a, T>> + Clone {
...
pub fn attribute_list<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Vec<Attribute>, Extra<'a, T>> + Clone {
    attribute()
        .separated_by(punctuator(Punctuator::Comma))
        .allow_trailing()
...
/// (6.7.12.1) attribute
#[apply(cached)]
pub fn attribute<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Attribute, Extra<'a, T>> + Clone {
    attribute_token()
...
pub fn attribute_token<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, AttributeToken, Extra<'a, T>> + Clone {
...
pub fn attribute_argument_clause<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, TokenStream, Extra<'a, T>> + Clone {
    select! {
...
pub fn translation_unit<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, TranslationUnit, Extra<'a, T>> + Clone {
...
pub fn external_declaration<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, ExternalDeclaration, Extra<'a, T>> + Clone {
    choice((
...
pub fn function_definition<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, FunctionDefinition, Extra<'a, T>> + Clone {
    attribute_specifier_sequence()
        .then(declaration_specifiers())
        .then(declarator())
...
fn identifier_or_keyword<'a, T: ContextTweaker + 'static>()
-> impl Parser<'a, Tokens<'a>, Identifier, Extra<'a, T>> + Clone {
    select! {
...
fn identifier<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Identifier, Extra<'a, T>> + Clone {
...
fn constant<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, Constant, Extra<'a, T>> + Clone {
    select! {
        Token::Constant(value) => value
    }
}

fn string_literal<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, StringLiterals, Extra<'a, T>> + Clone
{
    select! {
...
fn quoted_string<'a, T: ContextTweaker + 'static>() -> impl Parser<'a, Tokens<'a>, String, Extra<'a, T>> + Clone {
    select! {
        Token::QuotedString(value) => value
    }
}

fn keyword<'a, T: ContextTweaker + 'static>(kwd: &str) -> impl Parser<'a, Tokens<'a>, (), Extra<'a, T>> + Clone {
    select! {
        Token::Identifier(Identifier(name)) if name == kwd => ()
    }
}

fn punctuator<'a, T: ContextTweaker + 'static>(
    punc: Punctuator,
) -> impl Parser<'a, Tokens<'a>, (), Extra<'a, T>> + Clone {
    select! {
...
fn no_recover<'a, A, O, T: ContextTweaker + 'static>(parser: A) -> impl Parser<'a, Tokens<'a>, O, Extra<'a, T>> + Clone
where
    A: Parser<'a, Tokens<'a>, O, Extra<'a, T>> + Clone,
    O: Clone,
{
...
fn allow_recover<'a, A, O, T: ContextTweaker + 'static>(
    parser: A,
) -> impl Parser<'a, Tokens<'a>, O, Extra<'a, T>> + Clone
where
    A: Parser<'a, Tokens<'a>, O, Extra<'a, T>> + Clone,
    O: Clone,
{
...
fn recover_via_parser<'a, A, O, T: ContextTweaker + 'static>(
    parser: A,
) -> impl chumsky::recovery::Strategy<'a, Tokens<'a>, O, Extra<'a, T>> + Clone
where
    A: Parser<'a, Tokens<'a>, O, Extra<'a, T>> + Clone,
    O: Clone,
{
    via_parser(parser.try_map_with(
        |error, extra: &mut chumsky::input::MapExtra<'_, '_, Tokens<'a>, Extra<'a, T>>| {
...
fn recover_parenthesized<'a, O: Clone, T: ContextTweaker + 'static>(
    error: O,
) -> impl chumsky::recovery::Strategy<'a, Tokens<'a>, O, Extra<'a, T>> + Clone {
...
fn recover_bracketed<'a, O: Clone, T: ContextTweaker + 'static>(
    error: O,
) -> impl chumsky::recovery::Strategy<'a, Tokens<'a>, O, Extra<'a, T>> + Clone {
    recover_via_parser(select! {
